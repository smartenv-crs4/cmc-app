 ...
 *
 * @apiDescription Accessible by access_token of type specified in config.js SignUpAuthorizedAppAndMS field. Creates a new Application object and returns the access credentials.
 *
 ...
 * @apiGroup Application
 *
 * @apiDescription Accessible by access tokens of the type specified in "SignInAuthorizedAppAndMS" field in config.js. Logs in Application and returns the access credentials.
 *
 * @apiParam {String} access_token access token that grants access to this resource. It must be sent in [ body || as query param || header]
 ...
 * @apiGroup Application
 *
 * @apiDescription Accessible by admin access tokens specified in "adminUser" field in config.js. Returns the paginated list of all Applications.
 * Set pagination skip and limit in the URL request, e.g. "get /apps?skip=10&limit=50"
 *
 * @apiParam {String} access_token access token that grants access to this resource. It must be sent in [ body || as query param || header]
 *
 * @apiUse Metadata
 ...
 * @apiGroup Application
 *
 * @apiDescription Accessible by admin or AuthApp access tokens defined in config.js. Creates a reset password Token.
 *
 * @apiParam {String} access_token access token that grants access to this resource. It must be sent in [ body || as query param || header]
